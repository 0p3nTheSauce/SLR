...
model = model_zoo.get_config("common/models/mask_rcnn_fpn.py").model #type: ignore
constants = model_zoo.get_config("common/data/constants.py").constants #type: ignore
...
train = None
train.init_checkpoint = "detectron2://ImageNetPretrained/mvitv2/MViTv2_T_in1k.pyth" #type: ignore
