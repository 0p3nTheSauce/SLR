...
from .utils.misc import validate_checkpoint_wrapper_import
from torch.nn.init import trunc_normal_

from .build import MODEL_REGISTRY

try:
    from fairscale.nn.checkpoint import checkpoint_wrapper #type: ignore
except ImportError:
...
class MViT(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        if cfg.MODEL.ACT_CHECKPOINT:
            patch_embed = checkpoint_wrapper(patch_embed) #type: ignore
        ...
        for i in range(depth):
            ...
            if cfg.MODEL.ACT_CHECKPOINT:
                attention_block = checkpoint_wrapper(attention_block) #type: ignore
