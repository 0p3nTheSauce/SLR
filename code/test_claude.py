...
def run_visualizations(filepath: str = 'results.json',formatter=None):
    ...
    plot_model_comparison_bar(df, dataset='asl100', metric_type='avg', split='test')
    plot_model_comparison_bar(df, dataset='asl300', metric_type='avg', split='test')
    
    # 2. Heatmap comparison
    plot_heatmap_comparison(df, metric='top1_avg', split='test')
    
    # 3. Top-K progression
    plot_top_k_progression(df, dataset='asl100', split='test', metric_type='avg')
    plot_top_k_progression(df, dataset='asl300', split='test', metric_type='avg')
    
    # 4. Dataset comparison scatter
    plot_dataset_comparison_scatter(df, metric='top1_avg', split='test')
    
    # 5. Generate LaTeX tables
    latex_asl100 = generate_latex_table(
        results, 
        dataset='asl100', 
        split='test',
        metric_type='both',
    ...
    print("ASL100 LaTeX Table:\n")
    print(latex_asl100)
    
    latex_asl300 = generate_latex_table(
        results, 
        dataset='asl300', 
        split='test',
        metric_type='both',
