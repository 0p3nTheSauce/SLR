...
class IntanceDict(instance_dict):
...
def to_instance(d: instance_dict, label_num: int, label_name: str) -> IntanceDict:
...
def preprocess_split(
    ...
    for subset, instances in [
        ...
        instances, classes = (
            remove_short_samples(  # NOTE: this needs to be fixed, merge classes in video_dataset
        ...
        inst_path = output_dir / f"{subset}_instances{f_exstension}"
        clss_path = output_dir / f"{subset}_classes{f_exstension}"
