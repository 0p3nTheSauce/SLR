...
Frame_Size_Strategy = Literal["Centre_crop", "Random_crop", "Random_Resized_crop", "Scale_and_pad"]
...
class DataInfo(BaseModel):
	...
	def check_frame_strat(self) -> 'DataInfo':
		if self.train_augs is None and self.test_augs is None:
			raise ValueError('At least one aug info must be provided for sampler and croping')
		return self
